namespace LexsPublishDiscoverWebService
{
    ...
    public partial class SubstanceType : TangibleItemType
    {
        ...
        /// <remarks/>
        /// NOTE: the base type has an Items property, the derived type has to take that into account when
        /// creating the property name
        //[System.Xml.Serialization.XmlElementAttribute("SubstanceCode", Order=1)]
        [System.Xml.Serialization.XmlElementAttribute("DrugDEACode", typeof(DrugCategoryCodeType), Namespace = "http://niem.gov/niem/domains/jxdm/4.0", IsNullable = true, Order = 1)]
        [System.Xml.Serialization.XmlElementAttribute("HazardousMaterialCode", typeof(HazmatUNCodeType), Namespace = "http://niem.gov/niem/domains/jxdm/4.0", IsNullable = true, Order = 1)]
