...
internal static class NamingHelper
{
    ...
    internal static void CheckUriParameter(string ns, string paramName)
    {
        ...
        {
            throw DiagnosticUtility.ExceptionUtility.ThrowHelperArgument(paramName, SR.GetString("SFXUnvalidNamespaceParam", new object[] { ns }));
        }
    }
    ...
    internal static void CheckUriProperty(string ns, string propName)
    {
        ...
        if (!Uri.TryCreate(ns, UriKind.RelativeOrAbsolute, out uri))
        {
            throw DiagnosticUtility.ExceptionUtility.ThrowHelperArgument(SR.GetString("SFXUnvalidNamespaceValue", new object[] { ns, propName }));
        }
    }
