    ...
    internal sealed class ConfigurationDecorator : ICodeDecorator
    {
        ...
        private void AddMetadataServiceBehavior()
        {
            ...
            if (csg != null)
            {
                ...
                metadataServiceExtensionElement.Type = "Thinktecture.ServiceModel.Extensions.Metadata.StaticMetadataBehaviorElement, Thinktecture.ServiceModel.Extensions.Metadata, Version=1.0.10.0, Culture=neutral, PublicKeyToken=20fb7cabbfb92df4";                                                        
